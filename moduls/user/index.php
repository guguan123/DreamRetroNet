...
echo '<h2 class="topic">'.$user['name'].'</h2><ul class="list padding line bg-white"><li>注册日期：'.data($user['data_reg']).'</li><li>上传应用：'.$uw->num_rows.'个</li><li>下载应用：'.$user['downs'].'个</li><li>应用列表：'.$uk->num_rows.'个</li><li>发布评论：'.$uc->num_rows.'条</li><li>应用列表：'.$uk->num_rows.'个</li><li><a href="/log_login">登录历史</li></a></ul><h2 class="topic margin-top">管理菜单</h2><ul class="list padding line bg-white"><li><a href="/exit">注销登录</a></li><li>用户名：'.$user['login'].'</li><li><a href="/info/2">重置登录码请联系管理员</a></li><li><a href="/user/setPhone">设置我的功能机</a></li><li><a href="/upload">上传应用</a></li><li><a href="https://wj.qq.com/s2/8194727/7d55/">增加应用</a></li>';
