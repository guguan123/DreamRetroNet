...
if($user['admin_level']=="管理员") echo '<li>用户：'.$ua->num_rows.'</li>';
echo '<li>应用列表：'.$us->num_rows.'</li>';
...
echo '</ul></div></div>';
if($user['admin_level']=="管理员"){
echo "<div class='link'><a href='/review'>审核列表($num)</a></div>";
...
echo "<div class='link'><a href='/admin_settings'>网站设定</a></div>";
