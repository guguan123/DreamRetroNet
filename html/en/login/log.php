...
echo '<div class="message bg-white margin-top">访问本站即视为您同意<a href="/info/1">免责声明</a></div></div><div id="aside"><div class="message bg-white">智能机和电脑可以直接访问<a href="https://jvzh.cn">https://jvzh.cn</a>功能机需要先用智能机或电脑通过上述域名登录后在个人页面获取用户名。之后功能机可以凭借获取登录填写的用户名和密码在<a href="http://wap.jvzh.cn">http://wap.jvzh.cn</a>域名登录。</div></div></div>';
