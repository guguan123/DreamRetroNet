...
$start = 12*$page-12;
		$ms = $con->query("SELECT * FROM `games` WHERE `id` AND `id_game` = 0 ORDER BY `id` DESC LIMIT $start, 12");
...
echo '<ul class="list comment line padding bg-white" id="comment"><li class="clearfix"><a href="/info/16835"><img src="/M/ii/'.$w['id'].'" width="46" height="46" alt="头像" /></a><div><p><a href="/packages/edit/'.$w['id'].'">' . getJarIniName($ftext, "MIDlet-Name") . '</a></p>';
