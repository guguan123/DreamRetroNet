...
echo '<li><a href="/game/'.$u['id'].'" class="clearfix"><img src="/M/i/'.$u['id'].'.png" width="46" height="46" alt="图标" />';
if($name = $u['cn'] ?: $u['name']){
...
echo '<li><a href="/game/'.$download['game_id'].'" class="clearfix"><img src="/M/i/'.$download['game_id'].'.png" width="46" height="46" alt="图标" />';
